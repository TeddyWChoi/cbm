...
export default function Board3(props) {
    return (
            ...
            <div class="container">
                <div class="div">
                    <div class="div1">
                        <div class="general-wrapper">
                            <b class="general">General</b>
                        </div>
                        <div class="text-wrappper">
                            <b class="i-have-an">I have an inquiry. Waiting for your answer.</b>
                        </div>
                        <div class="frame-parent">
                            <div class="frame-wrapper">
                                <div class="teddy-wrapper">
                                    <div class="teddy">Teddy</div>
                                </div>
                            </div>
                            <div class="div2">
                                <div class="div-parent">
                                    ...
                                    <div class="icoutline-remove-red-eye-parent">
                ...
                <div class="component-1-parent">
                    ...
                    <div class="component-2">
                        <div class="divvar-box-inner1">
                            <div class="divvar-box-inner-child">
                                <div class="p-parent">
                                    <div class="frame-div">
                                        <div class="name-wrapper">
                                            <div class="name">Teddy</div>
                                        </div>
                                    </div>
                                    <div class="p3">
                                        <img class="time" alt="" src={require('../../assets/images/time.png')} />
