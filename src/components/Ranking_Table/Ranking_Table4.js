        ...
        <div className="Ranking_Table">
            <div class="table_border2">
                <div class="if-you-have-container">
                    Relics are treasures hidden for generations on the continent of Aika and all nations covet them for
                    possessing immense power. Steal relics from enemy nations to take advantage of their bonuses and
                    store them in the devirs, temples where the relics are sealed for a time until they are released for
                    a new theft.
                </div>
            </div>
            ...
            <div class="table table4">
                <div class="header-row">
                    <div class="cell-parent">
                        ...
                        <div class="cell4">
                            <b class="player">Stabilization</b>
                        </div>
                    </div>
                </div>
                <div class="body">
                    <div class="row4">
                        ...
                        <div class="data2">
                            <div class="player">XSALADXBANCON </div>
                        </div>
                        <div class="data3">
                            <div class="div">99</div>
                        </div>
                        <div class="data4">
                            <div class="player">September 1, 2024</div>
                        </div>
                    </div>
                    <div class="row41">
                        <div class="data">
